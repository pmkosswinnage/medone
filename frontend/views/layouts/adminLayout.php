...
<div class="wrapper">
 <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>MED-</b>One.com</span>
        </a>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <?php 
                        If ($roleid==1){   
                            echo '<i class="fa fa-dashboard"></i> <span>ADMIN PORTAL</span> <i class="fa fa-angle-left pull-right"></i>';
                        }
              ?>
             ...
             <li class="treeview">
              <a href="#">
               ...
               <?php 
                        If ($roleid==1){   
                            echo '<i class="fa fa-dashboard"></i> <span>PATIENT PORTAL</span> <i class="fa fa-angle-left pull-right"></i>';
                        } elseif ($roleid==2) {
                            echo '<i class="fa fa-dashboard"></i> <span>PATIENT PORTAL</span> <i class="fa fa-angle-left pull-right"></i>';
              ...
              <ul class="treeview-menu">
                  ...
                  <li class="active">
                        <?php 
                        If ($roleid==1){ 
                        echo $url = Html::a('<i class="fa fa-circle-o"> </i> ',
                        ['/site/indexstudent'],
                        ['class' => 'admin-year-index']);
                        
                        } elseif ($roleid==2) {
                            
                        echo $url = Html::a('<i class="fa fa-circle-o"> </i> - an online tool for your health',
                        ['/site/indexstudent'],
                        ['class' => 'admin-year-index']);
             ...
             <li class="treeview">
              <a href="#">
                ...
                <?php 
                        If ($roleid==1){   
                            echo ' <i class="fa fa-dashboard"></i> <span>DOCTOR PORTAL</span> <i class="fa fa-angle-left pull-right"></i>';
                        } elseif ($roleid==3) {
                            echo '<i class="fa fa-dashboard"></i> <span>DOCTOR PORTAL</span> <i class="fa fa-angle-left pull-right"></i>';
              ...
              <ul class="treeview-menu">
                     <li class="active">
                       <?php 
                        If ($roleid==1){ 
                        echo $url = Html::a('<i class="fa fa-circle-o"> </i> DOCTOR PORTAL',
                        ['/tutor/index'],
                        ['class' => 'admin-year-index']);
        ...
        <section class="content-header">
          <h1>
            ...
            <?php 
                    ...
                    Else  If ($roleid==2){
                            echo $url = Html::a('<small> PATIENT PORTAL</small>',
                                                            ['/site/indexstudent'],['class' => '']);
                        }

                    Else  If ($roleid==3){
                            echo $url = Html::a('<small> DOCTOR PORTAL</small>',
                                                            ['/tutor/index'],['class' => '']);
                        }    
                ?>   
...
<!--          <ol class="breadcrumb">
    ...
    <div class="container">
        ...
        <p class="pull-right">&copy; Pradeep Manjula Koswinnage (K2525755) :  MED ONE E-Channeling @ <?= date('Y') ?></p>
    </div>
    </footer>
