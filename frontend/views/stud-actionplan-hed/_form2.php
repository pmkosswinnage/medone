...
<?= $form->field($model, 'tutor_comments')->textarea(['rows' => 6]) ?>   
    
    
 <?= $form->field($model, 'tutor_com_date')->widget(
    ...
    <?= $form->field($model, 'feedback_hed_id')->dropDownList( 
                ...
                ->where(['id' =>$model->feedback_hed_id,'feedback_status'=>'Active'])
  ...
  <?= $form->field($model,'acad_year_id')->textInput(['readonly' => true]) ?>
   ...
   <?= $form->field($model,'module_id')->dropDownList(
    ...
    <?= $form->field($model, 'action_plan')->textarea(['readonly' => true],['rows' => 6]) ?>
    


    <?= $form->field($model, 'sucess_ind')->textarea(['readonly' => true],['rows' => 6]) ?>
